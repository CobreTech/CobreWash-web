...
export function useEditarComanda(options?: useDataConnectMutationOptions<EditarComandaData, FirebaseError, EditarComandaVariables>): UseDataConnectMutationResult<EditarComandaData, EditarComandaVariables>;
export function useEditarComanda(dc: DataConnect, options?: useDataConnectMutationOptions<EditarComandaData, FirebaseError, EditarComandaVariables>): UseDataConnectMutationResult<EditarComandaData, EditarComandaVariables>;

export function useEliminarDetallesComanda(options?: useDataConnectMutationOptions<EliminarDetallesComandaData, FirebaseError, EliminarDetallesComandaVariables>): UseDataConnectMutationResult<EliminarDetallesComandaData, EliminarDetallesComandaVariables>;
export function useEliminarDetallesComanda(dc: DataConnect, options?: useDataConnectMutationOptions<EliminarDetallesComandaData, FirebaseError, EliminarDetallesComandaVariables>): UseDataConnectMutationResult<EliminarDetallesComandaData, EliminarDetallesComandaVariables>;

export function useCrearTipoPrenda(options?: useDataConnectMutationOptions<CrearTipoPrendaData, FirebaseError, CrearTipoPrendaVariables>): UseDataConnectMutationResult<CrearTipoPrendaData, CrearTipoPrendaVariables>;
export function useCrearTipoPrenda(dc: DataConnect, options?: useDataConnectMutationOptions<CrearTipoPrendaData, FirebaseError, CrearTipoPrendaVariables>): UseDataConnectMutationResult<CrearTipoPrendaData, CrearTipoPrendaVariables>;
